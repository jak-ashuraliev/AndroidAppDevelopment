...
public class Constants {
    ...
    static final String KEY_AGE = "0";
    static final String KEY_EMAIL = "email";
    static final String KEY_OCCUPATION = "Occupation of the user goes here.";
    static final String KEY_DESCRIPTION = "Description of the user goes here.";
